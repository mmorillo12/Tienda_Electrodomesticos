...
public class Lavadora : Electrodomesticoss{
    double carga = 5;
    ...
    public Lavadora(double precio, double peso, string color, char consumo_energetico, double carga):base(precio, peso, color, consumo_energetico){
        this.carga = carga;
    }
...
public class Television : Electrodomesticoss{
    ...
    public Television(double precio, double peso, string color,char consumo_energetico,double resolucion, bool sintonizador_TDT):base(precio,peso,color,consumo_energetico){
